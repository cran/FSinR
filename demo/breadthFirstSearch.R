...
## Breadth First Search for mtcars dataset (filter method)
breadthFirstSearch(mtcars, 'mpg', binaryConsistency)

## Breadth First Search for iris dataset (wrapper classification)
...
## Breadth First Search for mtcars dataset (wrapper regression)
resamplingParams <- list(method = "cv", number = 10) # Values for the caret trainControl function
# Values for the caret train function (x, y, method and trainControl not neccesary)
